...
const SupportMessageCard: FC<SupportMessageCardProps> = ({
  content,
  createdAt,
  file
}) => {
  return (
    <Box className="flex w-full items-center justify-end">
      <Box className="flex w-[90%] flex-col gap-[10px] rounded-3xl border border-brand-white-normalHover bg-brand-white-normalHover p-6 text-brand-blue-normal lg:w-[60%]">
