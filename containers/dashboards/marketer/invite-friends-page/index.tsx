...
const MarketerDashboardInviteFriendsContainer: FC = () => {
  ...
  return (
    <Box>
      ...
      <InviteForm isMarketer />

      <Box className="mt-10 flex w-full flex-col gap-4 lg:mt-[74px]">
        <Box className="flex w-full items-center justify-center text-red-400">
          <Title level={2} className="lg:hidden">
            لطفا توجه داشته باشید که در هفته فقط میتوانید 100 نفر را دعوت کنید.
          </Title>
        ...
        {/* INVITE COUNT */}
        <Box className="mt-10 flex flex-col items-center gap-3 text-brand-blue-normal">
          <Title level={2} className="lg:hidden">
...
export default MarketerDashboardInviteFriendsContainer;
