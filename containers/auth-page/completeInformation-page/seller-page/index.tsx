...
import CompleteSignUpSellerForm from "@/components/forms/auth/signupForm/CompleteInforamtionForms/Seller";
import { Box } from "@chakra-ui/react";

const CompleteSignUpSellerContainer: FC = () => {
  return (
    <Box
      as="main"
        ...
        >
          ...
          >
            ...
            <CustomHeading level={5} className="text-brand-blue-normal" bold>
              احراز هویت پخش‌کننده
            </CustomHeading>
          </Box>
        </Box>
        <CompleteSignUpSellerForm />
      </Box>
    </Box>
  );
};

export default CompleteSignUpSellerContainer;
