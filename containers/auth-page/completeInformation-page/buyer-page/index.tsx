...
import CompleteSignUpBuyerForm from "@/components/forms/auth/signupForm/CompleteInforamtionForms/Buyer";

import { Box } from "@chakra-ui/react";

const CompleteSignUpBuyerContainer: FC = () => {
  return (
    <Box
      as="main"
    ...
    >
      <Box as="section" className="flex w-full flex-col items-center lg:w-full">
        ...
        <CompleteSignUpBuyerForm />
      </Box>
    </Box>
  );
};

export default CompleteSignUpBuyerContainer;
